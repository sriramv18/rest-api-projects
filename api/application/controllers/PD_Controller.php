...
class PD_Controller extends REST_Controller {
	...
	*/
	...
	public function getAssessedIncome_post()
	{
		...
		$fine = $this->calculateAssessedIncome($pd_id);
		if($fine != null)
		{
